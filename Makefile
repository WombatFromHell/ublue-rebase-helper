...
.PHONY: all clean install build test lint prettier format radon configure ci
.SILENT: all clean install build test lint prettier format radon configure ci
